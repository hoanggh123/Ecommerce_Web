          ...
          <div className="lg:col-span-1 maxt-auto max-w-2x1 px-4 pb-16 sm:px-6 lg:max-w-7x1 lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              ...
              <h1 className="text-lg lg:text-x1 text-gray-900 opacity-60 pt-1">
                Áo thun local brand unisex Otis Club – Tee Mood Day 4 MàuF
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="ml-3 cursor-pointer text-sm font-medium text-indigo-600 hover:text-indigo-500">
                    3870 Reviews
                  </p>
                </div>
              </div>
        ...
        <section>
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                <h1 className="text-1 font-semibold pb-1">Product Ratings</h1>
                <div className="flex items-center space-x-3">
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress
                        variant="determinate"
                        color="success"
                        sx={{ bgcolor: "while", borderRadius: 4, height: 7 }}
                        value={40}
                      ></LinearProgress>
                    </Grid>
                  </Grid>
