...
export default function Product() {
  ...
  const handleFilter = (value, sectionId) => {
    console.log("Đường dẫn hiện tại (location.search):", location.search);
    const searchParams = new URLSearchParams(location.search);
    let filterValue = searchParams.getAll(sectionId);
    console.log("Giá trị hiện tại của filterValue:", filterValue);
    ...
    const query = searchParams.toString();
    console.log("Giá trị của filterValue đã được cập nhật:", filterValue);
    console.log("Query sau khi cập nhật:", query);
    navigate({ search: `?${query}` });
